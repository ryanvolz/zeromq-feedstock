...
set "CPPFLAGS=/DUNITY_EXCLUDE_STDINT_H /DUNITY_POINTER_WIDTH=64"

cmake -G "NMake Makefiles" -D ENABLE_DRAFTS=OFF -D WITH_PERF_TOOL=OFF -D ZMQ_BUILD_TESTS=%TEST% -D ENABLE_CPACK=OFF -D CMAKE_BUILD_TYPE=Release -D CMAKE_INSTALL_PREFIX=%LIBRARY_PREFIX% ..
